...
public:
	...
	*/
    virtual void Print(const DwPtr<DwTextWriter>& textWriter, int depth ) const = 0;
...
public:
	...
	*/
    ...
    virtual void Print(const DwPtr<DwTextWriter>& textWriter, int depth) const;
...
public:
	...
	*/
    bool LoadStream(const DwPtr<DwStream>& stream, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
    bool SaveStream(const DwPtr<DwStream>& stream) const;
	...
	*/
    ...
    virtual void Print(const DwPtr<DwTextWriter>& textWriter, int depth = 0) const;
	// [internal use]
