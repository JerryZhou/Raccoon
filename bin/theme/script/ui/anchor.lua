...
local _anchor_proxy_metatable = 
{
    ...
    d_setLeft = function(self, p, l)
        base.Anchor.setLeft(self[1], AnchorLine(p, l))
    end,
    ...
    d_setRight = function(self, p, l)
        base.Anchor.setRight(self[1], AnchorLine(p, l))
    end,
    ...
    d_setTop = function(self, p, l)
        base.Anchor.setTop(self[1], AnchorLine(p, l))
    end,
    ...
    d_setBottom = function(self, p, l)
        base.Anchor.setBottom(self[1], AnchorLine(p, l))
    end,
    ...
    d_setHCenter = function(self, p, l)
        base.Anchor.setHCenter(self[1], AnchorLine(p, l))
    end,
    ...
    d_setVCenter = function(self, p, l)
        base.Anchor.setVCenter(self[1], AnchorLine(p, l))
    end,
