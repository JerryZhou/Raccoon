...
local mainWindow = FrameWindow
{
	...
	childrens = function(p)
		...
		p.m_loginBtn:d_setButtonImage("home:testdata/mu/all_btn_normal.png",
			"home:testdata/mu/btn_highlight.png",
			"home:testdata/mu/btn_down.png")
		p.m_loginBtn:d_setImage(Dw.SFocus, "home:testdata/mu/btn_focus.png")
		...
		p.m_multiAccountBtn:d_setButtonImage("home:testdata/mu/all_btn_normal.png",
			"home:testdata/mu/btn_highlight.png",
			"home:testdata/mu/btn_down.png")
		p.m_multiAccountBtn:d_setImage(Dw.SFocus, "home:testdata/mu/btn_focus.png")
		...
		p.m_settingBtn:d_setButtonImage("home:testdata/mu/all_btn_normal.png",
			"home:testdata/mu/btn_highlight.png",
			"home:testdata/mu/btn_down.png")
		p.m_settingBtn:d_setImage(Dw.SFocus, "home:testdata/mu/btn_focus.png")
		...
		p.m_headGraphics:d_setImage(Dw.SNormal, "home:testdata/mu/headdy.gif")
		...
		p.m_headMask:d_setButtonImage("home:testdata/mu/login_head_bkg__normal.png",
			"home:testdata/mu/login_head_bkg_highlight.png",
			"home:testdata/mu/login_head_bkg_highlight.png")
		p.m_headMask.background:d_setMargins( { 12, 12, 12, 12 } )
		...
		p.m_mid_mid = GraphicsItem
		{
			...
			childrens = function(pp)
				...
				pp.m_register = GraphicsSimpleTextItem { text = "Register", font = { color = {39, 134, 228}, size=13, style=Dw.FontStyleUnderline}}
				pp.m_retrieve = GraphicsSimpleTextItem { text = "Forgot", font = { color = {39, 134, 228}, size=13, style=Dw.FontStyleUnderline}}
